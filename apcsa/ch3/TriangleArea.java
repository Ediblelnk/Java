...
public class TriangleArea {
    ...
    public static void main(String[] args) {
        ...
        double dSideOne, dSideTwo, dSideThree, dSemiPerimeter, dArea;
        ...
        System.out.print(
            "Please input three side lengths, with a space between each: "
        );
        ...
        dArea = Math.sqrt(
            dSemiPerimeter *
                (dSemiPerimeter - dSideOne) *
                (dSemiPerimeter - dSideTwo) *
                (dSemiPerimeter - dSideThree)
        );

        // print the area rounded to three decimal places
        System.out.println(
            "\nArea of the Triangle: " +
                fmtDecimal.format(dArea) +
                " square units"
        );
