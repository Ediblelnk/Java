...
public class IntegerListTest {
    ...
    public static void execute(int iChoice) {
        ...
        switch (iChoice) {
            ...
            case 6:
                ...
                System.out.println(
                    "Replaced first value of " + iRequest + " with " + iHolder
                );
                break;
            case 7:
                //prompt for replacement and replace values
                ...
                System.out.println(
                    "Replaced all values of " + iRequest + " with " + iHolder
                );
                break;
            case 8:
                //print the list
    ...
    public static void printMenu() {
        ...
        System.out.println(
            "2: Sort list in ascending order using selection sort"
        );
        System.out.println(
            "3: Sort list in descending order using selection sort"
        );
        System.out.println("4: Find an element in list via linear search");
        System.out.println(
            "5: Find an element in list via binary search (only works when in descending order)"
        );
