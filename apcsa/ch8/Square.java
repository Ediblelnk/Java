...
public class Square {
    ...
    public int sumRow(int iRow) {
        ...
        int iIndex;
        int iSum = 0;
        for (iIndex = 0; iIndex < iSquare[iRow].length; iIndex++) iSum +=
            iSquare[iRow][iIndex];
        return iSum;
    }
    ...
    public int sumCol(int iCol) {
        ...
        int iIndex;
        int iSum = 0;
        for (iIndex = 0; iIndex < iSquare.length; iIndex++) iSum +=
            iSquare[iIndex][iCol];
        return iSum;
    }
    ...
    public void readSquare(Scanner scan) {
        int iRow, iCol;
        for (iRow = 0; iRow < iSquare.length; iRow++) for (
            iCol = 0;
            iCol < iSquare.length;
            iCol++
    ...
    public void printSquare() {
        ...
        for (iRow = 0; iRow < iSquare.length; iRow++) {
            for (iCol = 0; iCol < iSquare.length; iCol++) {
                if (iSquare[iRow][iCol] < 10 && iCol != 0) iSpace = "   ";
                else if (iSquare[iRow][iCol] < 10 && iCol == 0) iSpace = " ";
                else if (iSquare[iRow][iCol] > 9 && iCol != 0) iSpace = "  ";
                else if (iSquare[iRow][iCol] > 9 && iCol == 0) iSpace = "";
