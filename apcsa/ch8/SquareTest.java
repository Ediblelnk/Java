...
public class SquareTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (
            iSize != -1 //Expecting -1 at bottom of input file
        ) {
            ...
            for (iPlace = 0; iPlace < iSize; iPlace++) {
                System.out.println(
                    "Row " + (iPlace + 1) + " sum: " + current.sumRow(iPlace)
                );
            }
            System.out.println();
            ...
            for (iPlace = 0; iPlace < iSize; iPlace++) {
                System.out.println(
                    "Column " + (iPlace + 1) + " sum: " + current.sumCol(iPlace)
                );
            }
            System.out.println();
            ...
            System.out.println(
                "Top-left to Bottom-right sum: " + current.sumMainDiag()
            );

            //print the sum of the other diagonal (use a method from the Square class)
            System.out.println(
                "Top-right to Bottom-left sum: " + current.sumOtherDiag()
            );
