...
public class Salary {
    ...
    public static void main(String[] args) {
        ...
        if (sRating.toLowerCase().startsWith("ex")) dRaise = 0.035;
        //3.5% increase
        else if (sRating.toLowerCase().startsWith("go")) dRaise = 0.02;
        //2% increase
        else dRaise = 0.005; //0.5% increase
        ...
        System.out.println(
            "\nOld Salary:\t" +
                fmtCurrency.format(dCurrentSalary) +
                "\nRaise Percent:\t" +
                (dRaise * 100) +
                "%" +
                "\nRaise Amount:\t" +
                fmtCurrency.format((dRaise * dCurrentSalary)) +
                "\nNew Salary:\t" +
                fmtCurrency.format(dNewSalary)
        );
