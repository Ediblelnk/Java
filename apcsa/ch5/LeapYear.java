        ...
        while (bRunning) {
            while (iwYear < 1582) {
                ...
                try //try to assign the request to a year
                {
                    ...
                    if (iwYear < 1582) System.out.println(
                        "\nLeap years did not exist before 1582.\n"
                    );
                } catch (
                    Exception e //if unsuccessful display error message
                ) {
                    System.out.println(
            ...
            if (
                iwYear % 4 == 0 //leap year if divisible by 4
            ) {
                if (
                    iwYear % 100 == 0 //not a leap year if divisible by 100
                ) {
                    if (iwYear % 400 == 0) bLeapYear = true;
