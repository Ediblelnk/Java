...
public class RockPaperScissors {
    ...
    public static void main(String[] args) {
        ...
        while (bRunning) {
            ...
            if (iGenerated == 0) sComputerGuess = "rock";
            else if (iGenerated == 1) sComputerGuess = "paper";
            else sComputerGuess = "scissors";
            ...
            if (bRunning == false) {
                System.out.println(
                    "\nGame Ended" +
                        "\nTotal Rounds:\t" +
                        (iPlayerWinCount + iComputerWinCount + iTieCount) +
                        "\nPlayer Wins:\t" +
                        iPlayerWinCount +
                        "\nPlayer Losses:\t" +
                        iComputerWinCount +
