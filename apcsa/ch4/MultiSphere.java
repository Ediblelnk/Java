...
public class MultiSphere {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "SphereOne's diameter:\t\t" +
                SphereOne.getDiameter() +
                " units" +
                "\nSphereOne's volume:\t\t" +
                SphereOne.volume() +
                " units cubed" +
                "\nSphereOne's surface area:\t" +
        ...
        System.out.println(
            "\n\nSphereTwo's diameter:\t\t" +
                SphereTwo.getDiameter() +
                " units" +
                "\nSphereTwo's volume:\t\t" +
                SphereTwo.volume() +
                " units cubed" +
                "\nSphereTwo's surface area:\t" +
        ...
        System.out.println(
            "\n\nSphereThree's diameter:\t\t" +
                SphereThree.getDiameter() +
                " units" +
                "\nSphereThree's volume:\t\t" +
                SphereThree.volume() +
                " units cubed" +
                "\nSphereThree's surface area:\t" +
                SphereThree.surfaceArea() +
                " units squared" +
