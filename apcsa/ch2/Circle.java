...
public class Circle {
    ...
    public static void main(String[] args) {
       ...
       of circle */
        ...
        System.out.println(
            "The area of a circle with radius " + iRadius + " is " + dArea
        );
        System.out.println(
        ...
        System.out.println(
            "\nThe area of a circle with radius " + iRadius + " is " + dAreaTwo
        );
        System.out.println(
            "The circumference of a circle with radius" +
                iRadius +
       ...
       and the change in circumference */
        ...
        System.out.println(
            "The factor of change for circumference of the two circles is " +
