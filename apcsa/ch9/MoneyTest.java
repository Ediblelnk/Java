...
public class MoneyTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "\nTotal Value: " + iSum + " cents, $" + (iSum / 100.0)
        );
        ...
        for (iIndex = 0; iIndex < Pouch.length; iIndex++) {
            Pouch[iIndex].flip();
            if (!Pouch[iIndex].isHeads()) Pouch[iIndex].setValue(0);
        }
        ...
        for (iIndex = 0; iIndex < Pouch.length; iIndex++) {
            System.out.println(
                "Coin " +
                    ...
                    Pouch[iIndex].getValue() +
                    " cents" +
                    (Pouch[iIndex].getValue() == 0 ? " (tails)" : "")
            );
            iNewSum += Pouch[iIndex].getValue();
        }
        System.out.println(
            "\nNew Total Value: " + iNewSum + " cents, $" + (iNewSum / 100.0)
        );
