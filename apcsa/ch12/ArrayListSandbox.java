...
public class ArrayListSandbox {
    ...
    public static void executeOption(int iChoice) {
        ...
        switch (iChoice) {
            ...
            case 2: //remove item
                ...
                if (
                    iIndex == -1 //item is not found in list
            ...
            case 4: //get information about list
                ...
                System.out.println(
                    "The average cost per item is $" + (dTotalCost / iLength)
                );
                break;
    ...
    public static int findItem(String sRequest) {
        ...
        int iIndex;
        for (iIndex = 0; iIndex < groceryList.size(); iIndex++) if (
            sRequest.equals(groceryList.get(iIndex)[0])
        ) return iIndex;
    ...
    public static void lintList() {
        ...
        for (iIndex = 0; iIndex < groceryList.size(); iIndex++) {
            try //check if price is a number
            {
                ...
                Exception NumberFormatException //if price is not a number
            ) {
            ...
            try //check if quantity is a number
            {
                ...
                Exception NumberFormatException //if quantity is not a number
            ) {
    ...
    public static double totalCost() {
        ...
        for (iIndex = 0; iIndex < groceryList.size(); iIndex++) dTotal +=
            Double.valueOf(groceryList.get(iIndex)[1]) *
            Double.valueOf(groceryList.get(iIndex)[2]);
